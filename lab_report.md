...
-   Note that you need to submit a report generated by your defect tracking system, containing all defects recorded in the system.
...
- **Ashween:** exploratory testing (system familiarization, unexpected behaviors, usability issues, boundary conditions).
